...
void ShowArray(double* arr, unsigned int size)
{
...
void Task1(double* arr, unsigned int size)
{
	double result = 1;
...
void Task2(double* arr, unsigned int size)
{
	...
	for (unsigned int i = firstZeroIndex; i <= lastZeroIndex; i++)
		result += arr[i];
...
void Task3(double* arr, unsigned int size)
{
	unsigned int sizeWithoutZeroes = size;
